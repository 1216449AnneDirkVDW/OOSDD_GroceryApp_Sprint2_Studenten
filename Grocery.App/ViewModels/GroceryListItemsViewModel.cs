    ...
    public partial class GroceryListItemsViewModel : BaseViewModel
    {
        ...
        private void GetAvailableProducts()
        {
            ...
            foreach (var product in allProducts)
            {
                ...
                bool alreadyOnList = MyGroceryListItems.Any(i => i.ProductId == product.Id);

                if (hasStock && !alreadyOnList)
        ...
        public void AddProduct(Product product)
        {
            ...
            var newItem = new GroceryListItem(0, GroceryList.Id, product.Id, 0)
            {
                Product = product
            };
